...
describe("find parent", function() {
  it ("should return parent node", function() {
    ...
    binarySearchTree
      ...
      .insert(5)
      .insert(50);
    // expect(binarySearchTree._findParentNode(20).val).toEqual(15);
    // expect(binarySearchTree._findParentNode(10).val).toEqual(15);
    expect(binarySearchTree._findParentNode(12).val).toEqual(10);
  });
});
